...
<template>
  ...
  >
    <div class="flex flex-col gap-2 flex-1">
      ...
      <p v-else class="text-base text-ink-5 m-0">등록된 활동 없음</p>
    </div>

    <div class="flex items-center justify-between pt-[10px] border-t border-line">
      <button
        class="inline-flex items-center gap-[5px] px-[10px] py-[5px] rounded-lg border border-violet/25 bg-violet/8 text-violet text-base font-medium cursor-pointer transition-colors duration-150 hover:bg-violet/15 hover:border-violet/45"
